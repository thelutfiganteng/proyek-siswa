          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  ProyekSiswa.id berawal dari keprihatinan kami terhadap banyaknya ide bisnis inovatif dan ide penelitian dari pelajar dan
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Kami berkomitmen untuk mendukung ekosistem kewirausahaan pelajar di Indonesia
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <MotionCard className="p-6 text-center">
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-600">info@proyeksiswa.id</p>
